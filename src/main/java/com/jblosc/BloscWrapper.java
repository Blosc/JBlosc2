...
public class BloscWrapper {
	...
	/*
	 * public void freeCtx(ContextCparams context) { PointerByReference ptrByRef
	 * = new PointerByReference(); Pointer ptr = context.getPointer();
	 * ptrByRef.setPointer(ptr); BloscLibrary.blosc2_free_ctx(ptrByRef); }
	 * 
	 * public void freeCtx(ContextDparams context) { PointerByReference ptrByRef
	 * = new PointerByReference(); Pointer ptr = context.getPointer();
	 * ptrByRef.setPointer(ptr); BloscLibrary.blosc2_free_ctx(ptrByRef); }
	 */
